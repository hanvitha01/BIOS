...
{
  DEBUG((DEBUG_INFO,"SUPPORT FOR MYUSBKBDXE\n"));
  EFI_STATUS           Status;
  ...
  if (!IsUSBKeyboard (UsbIo)) {
    DEBUG((DEBUG_INFO,"SUPPORT SUCCESS FOR USBKBDXE\n"));
...
{
  DEBUG((DEBUG_INFO,"STARTED FOR MYUSBKBDXE\n"));
  EFI_STATUS                   Status;
  EFI_USB_IO_PROTOCOL          *UsbIo;
...
{
  DEBUG((DEBUG_INFO,"STOPPED FOR MYUSBKBDXE"));
  EFI_STATUS                      Status;
